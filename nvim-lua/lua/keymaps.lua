...
set('n', '<Leader>s', ':w<CR>', { silent = true, desc = 'save file' })
set('n', '<Leader>w', ':bd<CR>', { silent = true, desc = 'close buffer' })
...
set("n", "<leader>dH", "<Cmd>lua require'dap'.clear_breakpoints()<CR>", { silent = true, desc = 'clear all break points' })
