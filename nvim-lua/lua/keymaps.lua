...
set("n", "<leader>dl", ":call vimspector#Launch()<cr>", { silent = true, desc = 'launch debbuger' })
set("n", "<leader>dr", "<Plug>VimspectorRestart<cr>", { silent = true, desc = 'restart debbuger' })
set("n", "<leader>dR", ":call vimspector#Reset()<cr>", { silent = true, desc = 'reset debbuger' })
...
set("n", "<leader>dw", "<Plug>VimspectorBalloonEval<cr>", { silent = true, desc = 'eval variable' })
set("n", "<leader>do", "<Plug>VimspectorStepOver<cr>", { silent = true, desc = 'step over' })
set("n", "<leader>di", "<Plug>VimspectorStepInto", { silent = true, desc = 'step into' })
